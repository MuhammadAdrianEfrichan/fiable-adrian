...
const Galerry = ()=>{
    return <section className="relative flex min-h-128 flex-col items-center justify-center gap-10 bg-cover bg-center bg-no-repeat px-5 py-16 sm:px-10 sm:py-24 lg:h-161.25 lg:gap-15 lg:px-14.75 lg:py-32.75"
